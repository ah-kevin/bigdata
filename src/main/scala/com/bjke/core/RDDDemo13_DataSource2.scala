...
CREATE TABLE `t_student` (
  ...
  PRIMARY KEY (`id`)
    ...
    dataRDD.foreachPartition(iter => {
      ...
      val conn: Connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/bigdata?characterEncoding=UTF-8", "root", "890728")
     ...
     */
    val getConnection = () => DriverManager.getConnection("jdbc:mysql://localhost:3306/bigdata?characterEncoding=UTF-8", "root", "890728")
