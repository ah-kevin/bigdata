package com.bjke.spark.edu.analysis.streaming

import com.bjke.spark.edu.bean.Answer
import com.bjke.spark.edu.utils.RedisUtil
  ...
  def main(args: Array[String]): Unit = {
    ...
    |14        |[[1627, 2.8925943], [446, 2.8925943], [1951, 2.8925943], [1412, 2.8925943], [1812, 2.8925943], [1061, 2.8816805], [1661, 2.874632], [1453, 2.8682063], [1111, 2.8643343], [1797, 2.7966104]]|
        ...
        if (allInfoDF.count() > 0) {
          ...
          properties.setProperty("password", "890728")
          allInfoDF
            .write
            .mode(SaveMode.Append)
            .jdbc("jdbc:mysql://localhost:3306/bigdata?useUnicode=true&characterEncoding=utf8", "t_recommended", properties)
        }
